    ...
    <>
      <div className='w-full  h-full flex items-center lg:justify-start py-24 justify-center flex-wrap  '>
        <div className='lg:w-3/6 w-full sm:p-2 h-full my-2 flex items-center justify-center px-4 md:items-start md:justify-start md:p-20 flex-col '>
          <h1 className='md:text-6xl text-2xl sm:text-2xl font-extrabold mb-4 text-black '>To Choose <span className='text-green-600'>Right Jobs.</span> </h1>
          ...
          <div className='bg-white flex-col mb-6 w-full md:px-4   py-4 flex sm:flex-row items-center justify-center'>
            ...
            <button onClick={handleSearch} className='px-3 py-2 my-2 sm:my-0 border border-green-600 rounded uppercase tracking-widest mx-4   text-white bg-green-600 transition-all duration-700 hover:bg-transparent font-semibold text-base hover:text-green-600'>Search</button>
          </div>
        ...
        <div className='w-3/6 my-2 h-full bg-gray-200 hidden items-center justify-center flex-col p-20 lg:flex'>
          <Image width={600} height={700} src="/intro.svg" alt="no-image-found" className="mix-blend-multiply" />
        </div>
      </div>
      {
        doneSearch && (
